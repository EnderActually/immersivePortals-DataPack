...
#===< Sounds >===
execute as @s[scores={gravity_sneak=0}] at @s run playsound gravity_guns:launch voice @a ~ ~ ~ 0.3
execute as @s[scores={gravity_sneak=1..}] at @s run playsound gravity_guns:drop voice @a ~ ~ ~ 0.3
