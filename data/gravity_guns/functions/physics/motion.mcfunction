...
execute as @s[scores={gravity_power=1},type=!falling_block] store result storage gravity_guns:motion Motion[0] double 0.011 run scoreboard players get @s gravity_motion_x
execute as @s[scores={gravity_power=1},type=!falling_block] store result storage gravity_guns:motion Motion[1] double 0.011 run scoreboard players get @s gravity_motion_y
execute as @s[scores={gravity_power=1},type=!falling_block] store result storage gravity_guns:motion Motion[2] double 0.011 run scoreboard players get @s gravity_motion_z
