...
execute as @e[type=armor_stand,tag=portal.1] if score @s portal.sid = .portal_temp portal.sid run kill @s
summon armor_stand ~ ~.2 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["portal.1","portal.temp","portal.for.gun"],ArmorItems:[{},{},{},{id:"minecraft:air",Count:1b,tag:{display:{Name:'{"text":"Portal"}'},CustomModelData:1345435}}]}
